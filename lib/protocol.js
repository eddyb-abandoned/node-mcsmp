...
(function() {
    ...
    exports[17] = {};
    exports[17].client2server = exports.client2server;
    exports[17].server2client = exports.server2client;
    
    exports[16] = {};
    exports[16].client2server = exports.client2server;
    exports[16].server2client = exports.server2client;
    
    exports[15] = {};
    exports[15].client2server = clone(exports[16].client2server);
    ...
    exports[15].server2client = clone(exports[16].server2client);
    ...
    exports[14] = {};
    exports[14].client2server = clone(exports[15].client2server);
    ...
    exports[14].server2client = clone(exports[15].server2client);
...
exports.packers = packers, exports.unpackers = unpackers;
